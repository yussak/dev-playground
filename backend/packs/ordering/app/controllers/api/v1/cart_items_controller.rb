  ...
  module V1
    class CartItemsController < ApplicationController
      ...
      def create
        ...
        stock_quantity = variant.stock&.quantity || Catalog::Stock::DEFAULT_QUANTITY
        quantity_to_add = 1
      ...
      def update
        ...
        stock_quantity = cart_item.product_variant.stock&.quantity || Catalog::Stock::DEFAULT_QUANTITY

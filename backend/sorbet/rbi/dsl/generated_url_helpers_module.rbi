...
module GeneratedUrlHelpersModule
  ...
  def adjust_api_v1_product_variant_stock_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def api_v1_auth_register_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_cart_item_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_cart_items_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_cart_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_health_url(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def api_v1_product_coupon_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_product_coupons_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_product_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_product_variant_stock_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_products_url(*args); end

  sig { params(args: T.untyped).returns(String) }
  def cancel_api_v1_order_url(*args); end

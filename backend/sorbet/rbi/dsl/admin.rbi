...
class Admin
  ...
  sig { params(unencrypted_password: T.untyped).returns(T.any(Admin, FalseClass)) }
  ...
  module CommonRelationMethods
    ...
    sig { params(args: T.untyped).returns(T::Array[::Admin]) }
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Admin]])
    end
